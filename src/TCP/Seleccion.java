...
public class Seleccion {
     ...
     public static IndividuoTCP seleccionAleatoria(PoblacionTCP pob, int[][]mat, int [][] matrizi) {
        Random ran = new Random();
        int pos = ran.nextInt(pob.getPoblacion().size());

        return new IndividuoTCP(pob.getPoblacion().get(pos).getGenotipo(),mat,matrizi);
    }

//    public static IndividuoTCP seleccionRuleta(PoblacionTCP pob, int [][] mat, int[][] matrizi) {
